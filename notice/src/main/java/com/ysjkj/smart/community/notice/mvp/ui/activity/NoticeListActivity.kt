...
import kotlinx.android.synthetic.main.notice_activity_notice_list.*

@Route(path = RouterPath.Notice.LIST)
class NoticeListActivity : BaseActivity<EmptyPresenter>() {
    override fun initViewConfig(): ViewBuilder.() -> Unit = {
        withContent(R.layout.notice_activity_notice_list).withToolbar("小区公告", true)
    }
    ...
    override fun initView(savedInstanceState: Bundle?) {
        rcl_notice.apply {
            ...
            bindAdapter(mutableListOf<String>().apply { (1 until 10).forEach { add(it.toString()) } }, R.layout.notice_recycle_item_notice_list, mapOf()){
                helper,item->
                GlideApp.with(this@NoticeListActivity).load("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1524026099051&di=0a6174cb167555110e8aab8c50ca74d7&imgtype=0&src=http%3A%2F%2Fpic6.nipic.com%2F20100412%2F4410655_200439458739_2.jpg")
